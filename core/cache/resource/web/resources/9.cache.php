<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1494853053,
    'editedby' => 1,
    'editedon' => 1494853086,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1494853020,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
									...
									<div class="row 50%">
										<div class="4u">
											<a href="stati/poleznoe/17-statya-6.html" class="image fit">
												<img src="/assets/components/phpthumbof/cache/pic06.885e90039076ba81e547ca8b56e8dfcc9.jpg" alt="Статья_6" />
											</a>
										</div>
										<div class="8u">
...
<div class="row 50%">
										<div class="4u">
											<a href="stati/interosnoe/13-statya-2.html" class="image fit">
												<img src="/assets/components/phpthumbof/cache/pic06.885e90039076ba81e547ca8b56e8dfcc9.jpg" alt="Статья_2" />
											</a>
										</div>
										<div class="8u">
...
<div class="row 50%">
										<div class="4u">
											<a href="stati/interosnoe/12-statya-1.html" class="image fit">
												<img src="/assets/components/phpthumbof/cache/pic06.885e90039076ba81e547ca8b56e8dfcc9.jpg" alt="Статья_1" />
											</a>
										</div>
										<div class="8u">
...
`&showLog=``&fastMode=``&showUnpublished=``&showDeleted=``&showHidden=`1`&user=``&tplWrapper=``&plPrefix=``&maxLimit=`100`&page=`1`&pageVarKey=`page`&totalVar=`page.total`&pageLimit=`5`&element=`getTickets`&pageNavVar=`page.nav`&pageCountVar=`pageCount`&pageLinkScheme=``&tplPage=`@INLINE <li><a href="[[+href]]">[[+pageNo]]</a></li>`&tplPageWrapper=`@INLINE <div class="pagination"><ul class="pagination">[[+first]][[+prev]][[+pages]][[+next]][[+last]]</ul></div>`&tplPageActive=`@INLINE <li class="active"><a href="[[+href]]">[[+pageNo]]</a></li>`&tplPageFirst=`@INLINE <li class="control"><a href="[[+href]]">[[%pdopage_first]]</a></li>`&tplPageLast=`@INLINE <li class="control"><a href="[[+href]]">[[%pdopage_last]]</a></li>`&tplPagePrev=`@INLINE <li class="control"><a href="[[+href]]">&laquo;</a></li>`&tplPageNext=`@INLINE <li class="control"><a href="[[+href]]">&raquo;</a></li>`&tplPageSkip=`@INLINE <li class="disabled"><span>...</span></li>`&tplPageFirstEmpty=`@INLINE <li class="disabled"><span>[[%pdopage_first]]</span></li>`&tplPageLastEmpty=`@INLINE <li class="disabled"><span>[[%pdopage_last]]</span></li>`&tplPagePrevEmpty=`@INLINE <li class="disabled"><span>&laquo;</span></li>`&tplPageNextEmpty=`@INLINE <li class="disabled"><span>&raquo;</span></li>`&cache=``&cacheTime=`3600`&cacheAnonymous=``&ajax=``&ajaxMode=``&ajaxElemWrapper=`#pdopage`&ajaxElemRows=`#pdopage .rows`&ajaxElemPagination=`#pdopage .pagination`&ajaxElemLink=`#pdopage .pagination a`&ajaxElemMore=`#pdopage .btn-more`&ajaxTplMore=`@INLINE <button class="btn btn-default btn-more">[[%pdopage_more]]</button>`&ajaxHistory=``&setMeta=`1`&strictMode=`1`&request=`a8d6f04dabb58847ecd1656d334090cd`]]' => '<article id="main">
									...
									<p><a href="stati/poleznoe/16-statya-5.html">Читать далее...</a></p>
								</article>
<article id="main">
									<header>
										<h2><a href="stati/poleznoe/17-statya-6.html">Статья_6</a></h2>
										<p>
											Morbi convallis lectus malesuada sed fermentum dolore amet
										</p>
									</header>
									<a href="stati/poleznoe/17-statya-6.html" class="image featured"><img src="assets/images/pic06.jpg" alt="Статья_6" /></a>
									<p>Commodo id natoque malesuada sollicitudin elit suscipit. Curae suspendisse mauris posuere accumsan massa posuere lacus convallis tellus interdum. Amet nullam fringilla nibh nulla convallis ut venenatis purus lobortis. Auctor etiam porttitor phasellus tempus cubilia ultrices tempor sagittis. Nisl fermentum consequat integer interdum integer purus sapien. Nibh eleifend nulla nascetur pharetra com
									<p><a href="stati/poleznoe/17-statya-6.html">Читать далее...</a></p>
								</article>
<article id="main">
									<header>
										<h2><a href="stati/poleznoe/15-statya-4.html">Статья_4</a></h2>
										<p>
											Morbi convallis lectus malesuada sed fermentum dolore amet
										</p>
									</header>
									<a href="stati/poleznoe/15-statya-4.html" class="image featured"><img src="assets/images/pic06.jpg" alt="Статья_4" /></a>
									<p>Commodo id natoque malesuada sollicitudin elit suscipit. Curae suspendisse mauris posuere accumsan massa posuere lacus convallis tellus interdum. Amet nullam fringilla nibh nulla convallis ut venenatis purus lobortis. Auctor etiam porttitor phasellus tempus cubilia ultrices tempor sagittis. Nisl fermentum consequat integer interdum integer purus sapien. Nibh eleifend nulla nascetur pharetra com
									<p><a href="stati/poleznoe/15-statya-4.html">Читать далее...</a></p>
								</article>
<article id="main">
									<header>
										<h2><a href="stati/interosnoe/13-statya-2.html">Статья_2</a></h2>
										<p>
											Morbi convallis lectus malesuada sed fermentum dolore amet
										</p>
									</header>
									<a href="stati/interosnoe/13-statya-2.html" class="image featured"><img src="assets/images/pic06.jpg" alt="Статья_2" /></a>
									<p>Commodo id natoque malesuada sollicitudin elit suscipit. Curae suspendisse mauris posuere accumsan massa posuere lacus convallis tellus interdum. Amet nullam fringilla nibh nulla convallis ut venenatis purus lobortis. Auctor etiam porttitor phasellus tempus cubilia ultrices tempor sagittis. Nisl fermentum consequat integer interdum integer purus sapien. Nibh eleifend nulla nascetur pharetra com
									<p><a href="stati/interosnoe/13-statya-2.html">Читать далее...</a></p>
								</article>',
  ),
  'sourceCache' => 
  array (
